...
* What are the strategies for determining when to do what?
* Can we just 'mess' with data? .....YUP
* Log transforming y
* abs - absolute value
* Still not clear on why we need constant variables
* difference between statsmodels and sklearn
* data cleaning - categorical vs numerical and ordinal

### Word/Phrase of the day - Piggy Back
...
* multiple coefficients - $\beta_2, \beta_3, ...$

### Outline
* load in a dataset
* inspect (lightly) the data
* build a baseline model
* inspect the summary
* edit our model
* continue improving it or experimenting until we finish
...
![png](lesson-plan-04152019_files/lesson-plan-04152019_9_0.png)
...
![png](lesson-plan-04152019_files/lesson-plan-04152019_11_0.png)
...
<tr>
  <th>Time:</th>                 <td>11:29:55</td>     <th>  Log-Likelihood:    </th> <td> -7332.2</td> 
</tr>
<tr>
...
# dropping all features with pvalue > 0.05
...
<tr>
  <th>Time:</th>                 <td>11:39:28</td>     <th>  Log-Likelihood:    </th> <td> -7334.6</td> 
</tr>
<tr>
...
<tr>
  <th>Time:</th>                 <td>11:41:27</td>     <th>  Log-Likelihood:    </th> <td> -7336.4</td> 
</tr>
<tr>
  <th>No. Observations:</th>      <td> 10000</td>      <th>  AIC:               </th> <td>1.468e+04</td>
</tr>
...
```python
df_sub = df[["feature_4", "feature_5", "feature_6", "feature_7", "target"]]
corr = df_sub.corr()
```
...
![png](lesson-plan-04152019_files/lesson-plan-04152019_29_0.png)
...
![png](lesson-plan-04152019_files/lesson-plan-04152019_31_0.png)
...
<tr>
  <th>Time:</th>                 <td>12:09:11</td>     <th>  Log-Likelihood:    </th> <td> -7340.3</td> 
</tr>
<tr>
  <th>No. Observations:</th>      <td> 10000</td>      <th>  AIC:               </th> <td>1.469e+04</td>
</tr>
...
<tr>
  <th>feature_4</th> <td>    0.0039</td> <td> 6.19e-05</td> <td>   63.012</td> <td> 0.000</td> <td>    0.004</td> <td>    0.004</td>
</tr>
<tr>
...
<tr>
  <th>Kurtosis:</th>      <td> 2.909</td> <th>  Cond. No.          </th> <td>1.14e+04</td>
</tr>
</table>
...
```python
df_sub["feature_4"] = 100*df_sub["feature_4"]
```
...
### What is our linear regression equation?

$$ Y = 675 + 39.03x_4 + 70.08x_5 + 70.20x_6 + 73.71x_7$$
...
```python
"""
We have an r2 score of .81, which is nice and we have 
high confidence because all of our pvalues are 0.000
feature_4 is contributing the least to our predictions, because it's 
coefficient has the smallest magnitude while features 5 through 7 are
contributing similarly with feature_7 having the greatest weight of 73.71.

Skewness and Kurtosis are 0 and 3.0 respectively which implies that our 
predictions are normally distributed.

JB score is low -> normal
"""
```
...
```python
x_vals = df_sub.drop(["target"], axis=1).values
x_vals
```
    ...
    array([[-1.94840830e+01, -3.96639425e-03,  9.68283228e-03,
            -4.63905343e-03],
           [ 6.70621344e+01, -1.12013966e-02,  5.48644453e-03,
            -5.40983173e-03],
           [-6.12703444e+01,  3.21635186e-03, -1.21193007e-02,
            -5.53003281e-03],
           ...,
           [ 2.19287231e+01, -7.70772363e-03,  1.27145080e-02,
            -4.30558784e-03],
           [ 1.96176610e+02,  6.07355155e-03, -7.79135537e-03,
             7.61395531e-03],
           [ 2.47219317e+01, -5.26851152e-03, -1.25109268e-02,
            -6.41913746e-03]])
...
```python
residuals = df_sub.target - y_vals
```


```python
plt.figure(figsize=(6, 6))
plt.scatter(np.linspace(0, 1, 10000), residuals)
...
![png](lesson-plan-04152019_files/lesson-plan-04152019_48_0.png)
...
![png](lesson-plan-04152019_files/lesson-plan-04152019_49_0.png)


### What is a way to bring things to the same scale?
ZScores!!!!!
...
* Learned the workflow for analyzing data
* What to look for in a summary
    * pvalues
    * coefficients
    * r2 score
* Learned what linear regression process
* How weights are determined in linear regression
* We identified multicollinearity and how to identify it
* multicollinearity is bad because all things held constant minus your feature can no longer, with certainty determine how y changes
